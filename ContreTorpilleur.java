...
/**
 * Classe ContreTorpilleur heritant de la classe Bateau
 */
public class ContreTorpilleur extends Bateau implements Serializable {
    ...
    /**
     * Constructeur de la classe ContreTorpilleur prenant en parametres la grille dans laquelle
     ...
     */
    public ContreTorpilleur(Grille g, boolean o, Case c) throws BateauException{
        super(g, o);
