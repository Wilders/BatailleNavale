...
public class PorteAvions extends Bateau implements Serializable {
    ...
    /**
     * Constructeur de la classe PorteAvions prenant en parametres la grille dans laquelle
     ...
     */
    public PorteAvions(Grille g, boolean o, Case c) throws BateauException{
        super(g, o);
